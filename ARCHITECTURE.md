...
relations, semantic and literature retrieval, source-grounded judgments,
and real model/provider protocols. Bulk values are data frames or
caller-owned DuckDB relations; S7 is reserved for prompt, embedding,
parser, and annotator provider protocols.
